...
public class MasterMindUI {
    ...
    // Quitamos private para uso en Test
    static final Color BASE_COLOR = new Color(187, 183, 172);
    ...
    private void colorPins(Circle[] pins, MasterMindLogic.Result result) {
        ...
        if (blacks == 4) {
            ...
            // Eliminamos return aquí para que se pinten los pines negros
        } else {
            showMessage("Black: " + blacks + ". White: " + whites);
        }

        // Solo mostramos derrota si no hemos ganado
        if (currentRow == 9 && blacks < 4) {
    ...
    // Método público param el testing
    public void checkRound() {
        ...
        if (allFilled) {
            ...
            showMessage("Please fill all slots before checking!");
        }
    }
    ...
    private JPanel createBottomPanel(Color[] colors, String[] labels) {
        ...
        checkBtn.addActionListener(e -> checkRound());
